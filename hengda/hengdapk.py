...
class Hengdapk:
    ...
    def Pankou(self,head_txt):
        ...
        _pk +="</div>"
        _pk +="</div>"
        _pk += "<div class=\"pankou\">"
        _pk +="<div class=\"fm\"><b>恒大盘口 亚盘</b> <a target=\"_blank\" href=\"http://live.sportscn.com/news.html\" class=\"more\">更多&gt;&gt;</a>"
        _pk += "</div>"
        _pk += "<div class=\"fm_b2\">"
        _pk += "<ul>"
        _pk += "<table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\">"
        _pk += "<tbody><tr>"
        _pk +="<td>立博</td>"
        _pk +="<td>0.80</td>"
        _pk +="<td>受平手半球</td>"
        ...
        _pk +="</div>"
        _pk +="<div class=\"pankou\">"
        _pk +="<div class=\"fm\"><b>恒大盘口 欧赔</b> <a target=\"_blank\" href=\"http://live.sportscn.com/news.html\" class=\"more\">更多&gt;&gt;</a>"
        _pk +="</div>"
        _pk +="<div class=\"fm_b2\">"
        _pk +="<ul>"
        _pk +="<table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\">"
